         ...
         <div class="app-card-body p-3 p-lg-4">
            ...
            <div class="row gx-5 gy-3">
               <div class="col-12 col-lg-9">
                  <div>Download laporan perhitungan.</div>
               </div>
               <div class="col-12 col-lg-3">
                  <a class="btn app-btn-primary" href="/hitung/print_history"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-arrow-down me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
