            ...
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <div class="auth-form-container text-start mx-auto">
                        <form class="auth-form auth-signup-form" action="/register/save" method="post">
                            ...
                            <div class="password mb-3">
                                <label class="sr-only" for="confpassword">Confirmation Password</label>
                                <input id="confpassword" name="confpassword" type="password" class="form-control signup-password" placeholder="Repeat password" required="required">
                            </div>
