            ...
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <div class="auth-form-container text-start">
                        <form class="auth-form login-form" action="/login/auth" method="post">
                            <div class="email mb-3">
                                <label class="sr-only" for="signin-email">Email</label>
                                <input id="signin-email" name="email" type="email" class="form-control signin-email" placeholder="Email address" required="required" value="<?= set_value('email') ?>">
                            </div>
            ...
            <div class="auth-background-overlay p-3 p-lg-5">
                <div class="d-flex flex-column align-content-end h-100">
                    ...
                    <div class="overlay-content p-3 p-lg-4 rounded">
                        <h5 class="mb-3 overlay-title">Sistem Pendukung Keputusan dengan Metode </h5>
                        <div>Oleh : <br> Muhammad Zainal <br> STMIK Widya Pratama</div>
                    </div>
                </div>
            </div>
